...
public class MainActivity extends AppCompatActivity {
    ...
    public Element[] elements = new Element[] {
            ...
            new Element("Ge", 32, "metaloide", "Germanium", "72.64(1) u", "[Ar] 3d10 4s2 4p2", "sòlid"),
            new Element("As", 33, "metaloide", "Arsenic", "74.92160(2) u", "[Ar] 3d10 4s2 4p3", "sòlid"),
            ...
            new Element("Sb", 51, "metaloide", "Antimony", "121.760(1) u", "[Kr] 4d10 5s2 5p3", "sòlid"),
