...
public class ActivityGameEncertarNom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_encertar_nom);
    ...
    private void comprovarResultat() {
        EditText input = (EditText) findViewById(R.id.edtSimbolElement);
    ...
    private void snackbarDialogBuit() {
        View parentLayout = findViewById(android.R.id.content);
        Snackbar snack = Snackbar.make(parentLayout, Html.fromHtml("<font color=\"black\">INTRODUEIX UN SÍMBOL!</font>"), Snackbar.LENGTH_LONG);
    ...
    private void alertError() {
        ...
        alerta.setMessage("T'has equivocat, el símbol de l'element " + nomElementActual + " és " + simbolElementActual);
