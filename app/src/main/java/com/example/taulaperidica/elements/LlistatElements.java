...
public class LlistatElements {
    ...
    public static final Element[] elements = new Element[] {
            ...
            new Element("Al", 13, "metall post-transició", "Aluminum", "26.9815386(8) u", "[Ne] 3s2 3p1", "sòlid"),
            ...
            new Element("Ga", 31, "metall post-transició", "Gallium", "69.723(1) u", "[Ar] 3d10 4s2 4p1", "sòlid"),
            ...
            new Element("In", 49, "metall post-transició", "Indium", "114.818(3) u", "[Kr] 4d10 5s2 5p1", "sòlid"),
            new Element("Sn", 50, "metall post-transició", "Tin", "118.710(7) u", "[Kr] 4d10 5s2 5p2", "sòlid"),
            ...
            new Element("Tl", 81, "metall post-transició", "Thallium", "204.3833(2) u", "[Xe] 4f14 5d10 6s2 6p1", "sòlid"),
            new Element("Pb", 82, "metall post-transició", "Lead", "207.2(1) u", "[Xe] 4f14 5d10 6s2 6p2", "sòlid"),
            new Element("Bi", 83, "metall post-transició", "Bismuth", "208.98040(1) u", "[Xe] 4f14 5d10 6s2 6p3", "sòlid"),
