...
public class LlistatElements {
    ...
    public static final Element[] elements = new Element[] {
            ...
            new Element("Be", 4, "metall alcalino-terrós", "BerilÂ·li", "9.012182(3)", "[He] 2s2", "sòlid"),
            ...
            new Element("Ne", 10, "gas noble", "NeÃ³", "20.1797(6)", "[He] 2s2 2p6", "gas"),
            ...
            new Element("P", 15, "no metàlic", "FÃ²sfor", "30.973762(2)", "[Ne] 3s2 3p3", "sòlid"),
            new Element("S", 16, "no metàlic", "Sofre", "32.065(5)", "[Ne] 3s2 3p4", "sòlid"),
            new Element("Cl", 17, "halògen", "Clor", "35.453(2)", "[Ne] 3s2 3p5", "gas"),
            new Element("Ar", 18, "gas noble", "ArgÃ³", "39.948(1)", "[Ne] 3s2 3p6", "gas"),
            ...
            new Element("Mn", 25, "metall de transició", "ManganÃ¨s", "54.938045(5)", "[Ar] 3d5 4s2", "sòlid"),
            ...
            new Element("Ni", 28, "metall de transició", "NÃ­quel", "58.6934(4)", "[Ar] 3d8 4s2", "sòlid"),
            ...
            new Element("Ga", 31, "metal", "GalÂ·li", "69.723(1)", "[Ar] 3d10 4s2 4p1", "sòlid"),
            new Element("Ge", 32, "metal·loide", "Germani", "72.64(1)", "[Ar] 3d10 4s2 4p2", "sòlid"),
            new Element("As", 33, "metal·loide", "ArsÃ¨nic", "74.92160(2)", "[Ar] 3d10 4s2 4p3", "sòlid"),
            ...
            new Element("Mo", 42, "metall de transició", "MolibdÃ¨", "95.96(2)", "[Kr] 4d5 5s1", "sòlid"),
            ...
            new Element("Pd", 46, "metall de transició", "PalÂ·ladi", "106.42(1)", "[Kr] 4d10", "sòlid"),
            ...
            new Element("Te", 52, "metal·loide", "TelÂ·luri", "127.60(3)", "[Kr] 4d10 5s2 5p4", "sòlid"),
            new Element("I", 53, "halògen", "Iode", "126.90447(3)", "[Kr] 4d10 5s2 5p5", "sòlid"),
            new Element("Xe", 54, "gas noble", "XenÃ³", "131.293(6)", "[Kr] 4d10 5s2 5p6", "gas"),
            ...
            new Element("La", 57, "lanthanoid", "LantÃ ", "138.90547(7)", "[Xe] 5d1 6s2", "sòlid"),
            ...
            new Element("Ta", 73, "metall de transició", "TÃ ntal", "180.94788(2)", "[Xe] 4f14 5d3 6s2", "sòlid"),
            new Element("W", 74, "metall de transició", "TungstÃ¨", "183.84(1)", "[Xe] 4f14 5d4 6s2", "sòlid"),
            ...
            new Element("Pt", 78, "metall de transició", "PlatÃ­", "195.084(9)", "[Xe] 4f14 5d9 6s1", "sòlid"),
            ...
            new Element("Tl", 81, "metal", "TalÂ·li", "204.3833(2)", "[Xe] 4f14 5d10 6s2 6p1", "sòlid"),
            ...
            new Element("At", 85, "halògen", "AstÃ tic", "210", "[Xe] 4f14 5d10 6s2 6p5", "sòlid"),
            new Element("Rn", 86, "gas noble", "RadÃ³", "222", "[Xe] 4f14 5d10 6s2 6p6", "gas"),
            new Element("Fr", 87, "metall alcalí", "Francium", "223", "[Rn] 7s1", "sòlid"),
            new Element("Ra", 88, "metall alcalino-terrós", "RÃ dio", "226", "[Rn] 7s2", "sòlid"),
